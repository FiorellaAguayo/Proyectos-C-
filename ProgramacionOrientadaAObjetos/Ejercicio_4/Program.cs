...
namespace Ejercicio_4
{
    internal class Program
    {
        ...
        {
            Pen bluePen = new Pen(ConsoleColor.Blue, 100);
            Pen redPen = new Pen(ConsoleColor.Red, 50);

            // Usar los métodos para probar el comportamiento de los bolígrafos

            Console.WriteLine(bluePen);

            string drawing;
            bluePen.Paint(10, out drawing);
            Console.WriteLine("Dibujo con el bolígrafo azul: " + drawing);
            Console.WriteLine(bluePen);


            Console.WriteLine(redPen);

            redPen.Recharge();
            Console.WriteLine(redPen);

            redPen.Paint(20, out drawing);
            Console.WriteLine("Dibujo con el bolígrafo rojo: " + drawing);
            Console.WriteLine(redPen);
